...
De viktigste og mest relevante delene av intervjuet gjort 24. mars ble transkribert og analysert. Sju hovedtemaer ble identifisert
(her betyr tjeneste det samme som HelsaMi+):

\begin{description}
    \item[Bakgrunn for tjenesten] Hvorfor Trondheim kommune? Hvem finansierer prosjektet? Hvordan jobber Trondheim kommune med
		velferdsteknologi?
	\item[Om tjenesten per i dag] Hvor mange brukere? Pris på løsningen? Hvor mange bruker sensorer?
	\item[Tjenesteforløp] Hvordan får brukerne tilbud om tjenesten og hva skjer da?
	\item[Motivasjon for tjenesten] Hvorfor avstandsoppfølging? Hvilke fordeler kan det gi for kommunen?
	\item[Politiske beslutninger og samhandling] Hva er strategien til Trondheim kommune på velferdsteknologiområdet? Hvordan påvirker denne
		de valgene som er tatt i tjenesten? Hvilke utfordringer har kommunen i samarbeidet med andre aktører som fastleger og sykehusene?
    ...
    \item[Utfordinger med brukeropplevelse og sikkerhet] Er kommunen fornøyd med brukergrensesnittet? Hvilke tanker har kommunen om sikkerhet
