...
Som nevnt tidligere, bygger forskningsprosessen på boken «Researching Information Systems and Computing» \citep{oates} (figur \ref{fig:oates_model}).
...
For å belyse spørsmålet er forskningsløpet som i figur \ref{fig:oates_fs1}. Eksempelstudie er hovedstrategien, og intervjuer og dokumenter
...
I følge \citet[s.121-122]{oates} er fordelene til design og kreasjon-strategien at det er enklere å relatere til noe som eksisterer i virkeligheten enn en íde, en tanke eller et konsept.
...
Validitet og objektivitet er dermed ikke like relevant for dette prosjektet. Lincoln og Guba foreslår, i følge \citet{oates}, at kriteriene for interpretivisme
